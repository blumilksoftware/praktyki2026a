...
class SeatingServiceTest extends TestCase
{
     ...
     */
    public function test_two_friends_sharing_one_game_form_a_single_table(): void
    {
     ...
     */
    public function test_friends_with_different_preferences_sit_at_separate_tables(): void
    {
     ...
     */
    public function test_max_players_is_respected_and_highest_raters_chosen(): void
    {
     ...
     */
    public function test_game_below_min_players_triggers_force_assign(): void
    {
     ...
     */
    public function test_each_friend_appears_in_exactly_one_table(): void
    {
     ...
     */
    public function test_all_friends_are_accounted_for_in_output(): void
    {
        $game  = $this->makeGame(id: 1, min: 2, max: 4);
     ...
     */
    public function test_empty_friends_returns_empty_result(): void
    {
        $game   = $this->makeGame(id: 1, min: 2, max: 4);
     ...
     */
    public function test_empty_games_returns_no_tables(): void
    {
     ...
     */
    public function test_friend_with_no_ratings_ends_up_unseated(): void
    {
        $game  = $this->makeGame(id: 1, min: 2, max: 4);
     ...
     */
    public function test_minimum_rating_of_one_still_qualifies_for_seating(): void
    {
        $game  = $this->makeGame(id: 1, min: 2, max: 4);
