...
class GameSeeder extends Seeder
{
    public function run(): void
    {
        $games = [
            ...
            ["name" => "Na Skrzydlach", "min_players" => 1, "max_players" => 5, "is_shared" => true, "user_id" => null],
            ["name" => "7 Cudow Swiata", "min_players" => 2, "max_players" => 7, "is_shared" => true, "user_id" => null],
            ...
            ["name" => "Tysiac", "min_players" => 3, "max_players" => 4, "is_shared" => true, "user_id" => null],
